  ...
  return (
    <>
      <button
        ...
        className="absolute left-4 top-1/2 inline-flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-[var(--color-rule)] bg-white/85 text-[var(--color-ink)] hover:bg-white"
      >
        <LogIn className="h-4 w-4" aria-hidden />
      </button>
      <span
